...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(){return new Gr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function io(){return new Gr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ao(),fragmentShader:`
